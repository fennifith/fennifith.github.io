...
async function main() {
    ...
    let repos = await _request.github("users/fennifith/repos?per_page=1000");
    ...
    let people = await _request.github("users/fennifith/following?per_page=1000");
    ...
    let orgs = await _request.github("users/fennifith/orgs");
